...
if __name__ == '__main__':
    ...
    model_save_path = PROJ_PATH + "data/models/exp_1.5/"
    ...
    preproc_df = preproc_1_5_exp(df, base_features=needest_columns + [target_col] + [group_col] + [time_col], add_sandsnum_f=True)
    # get meedest columns
    ...
    reg_trees.fit(X, y)
    joblib.dump(reg_trees, model_save_path + f'rt_ad_sand.joblib')
