...
if __name__ == '__main__':
    ...
    model_path = PROJ_PATH + "data/models/exp_1.5/rt_ad_sand.joblib"
    sub_save_path = PROJ_PATH + "data/processed/1_5_subm_ad_sand.csv"
    ...
    preproc_df = preproc_1_5_exp(df, base_features=needest_columns + [group_col] + [time_col], add_sandsnum_f=True)
    # get meedest columns
    ...
    needest_columns = needest_columns + needest_sand_columns + ['steam_inj_nums'] +\
                      ['seq_num_un', 'fcl_life_time', 'fcl_sand_life_time'] + ['sands_num']
